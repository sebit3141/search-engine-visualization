var ns=ns||{};ns.sev=ns.sev||{};ns.sev.currentPage=1;ns.sev.serpsPerPage=10;ns.sev.clusters=[];ns.sev.solr={};ns.sev.solr.qt="/clustering";ns.sev.solr.wt="wt=json";ns.sev.solr.facet="facet=true&facet.field=text_facet";ns.sev.solr.urlLocal="http://localhost:5000/sevCore";ns.sev.solr.urlHeroku="https://solr-clustering.herokuapp.com/sevCore";ns.sev.solr.url=ns.sev.solr.urlLocal;ns.sev.solr.query=ns.sev.solr.url+ns.sev.solr.qt+"?"+ns.sev.solr.wt+"&"+ns.sev.solr.facet;ns.sev.resultSolrJSON={};
ns.sev.resultSolrSelectJSON={};ns.sev.resultClusterTreeJSON={};ns.sev.resultLinksNodesForceJSON={};ns.sev.resultClusterNodesJSON={};ns.sev.resultFacetingJSON={};ns.sev.loadScript=function(){ns.sev.ajaxSolrClustering();ns.sev.setQueryStringBold(document.getElementById("input-query").value,"hilitor");$("#loadButton").click(function(b){ns.sev.loadNextPageClient(b,ns.sev.resultSolrJSON)})};
ns.sev.afterAJAX=function(){ns.sev.resultFacetingJSON=ns.sev.getFacetingJSON(ns.sev.resultSolrJSON);ns.sev.drawD3WordCloud(ns.sev.resultFacetingJSON);$("li#tab-word-cloud").click(function(){$("div#word-cloud svg").remove();ns.sev.resultFacetingJSON=ns.sev.getFacetingJSON(ns.sev.resultSolrJSON);ns.sev.drawD3WordCloud(ns.sev.resultFacetingJSON);ns.sev.refreshSerps(ns.sev.resultSolrJSON)});$("li#tab-tree").click(function(){$("div#draw-tree svg").remove();ns.sev.resultClusterTreeJSON=ns.sev.getClusterTreeJSON(ns.sev.resultSolrJSON);
ns.sev.drawD3Tree(ns.sev.resultClusterTreeJSON);ns.sev.refreshSerps(ns.sev.resultSolrJSON)});$("li#tab-radial-tree").click(function(){$("div#draw-radial-tree svg").remove();ns.sev.resultClusterTreeJSON=ns.sev.getClusterTreeJSON(ns.sev.resultSolrJSON);ns.sev.drawD3TreeRadial(ns.sev.resultClusterTreeJSON);ns.sev.refreshSerps(ns.sev.resultSolrJSON)});$("li#tab-force-graph").click(function(){$("div#draw-force-graph svg").remove();ns.sev.resultLinksNodesForceJSON=ns.sev.getLinksNodesForceJSON(ns.sev.resultSolrJSON);
ns.sev.drawD3ForceGraph(ns.sev.resultLinksNodesForceJSON);ns.sev.refreshSerps(ns.sev.resultSolrJSON)});$("li#tab-force-search-graph").click(function(){$("div#draw-force-search-graph svg").remove();ns.sev.resultClusterTreeJSON=ns.sev.getClusterTreeJSON(ns.sev.resultSolrJSON);ns.sev.drawD3ForceSearchGraph(ns.sev.resultClusterTreeJSON);ns.sev.refreshSerps(ns.sev.resultSolrJSON)});$("li#tab-force-cluster-nodes").click(function(){$("div#draw-force-cluster-nodes svg").remove();ns.sev.resultClusterNodesJSON=
ns.sev.getClusterNodesJSON(ns.sev.resultSolrJSON);ns.sev.drawD3ForceClusterNodes(ns.sev.resultClusterNodesJSON);ns.sev.refreshSerps(ns.sev.resultSolrJSON)});ns.sev.responsiveD3()};ns.sev.ajaxSolrClustering=function(){$.ajax({url:ns.sev.solr.query,dataType:"jsonp",jsonp:"json.wrf",success:function(b){ns.sev.resultSolrJSON=b;ns.sev.afterAJAX()},error:function(b,g){console.log(b);console.log(g)}})};ns.sev.setQueryStringBold=function(b,g){(new Hilitor(g)).apply(b)};
...
ns.sev.getClusterTreeJSON=function(b){var g={name:"",children:[],docs:[],depth:"",tooltip:""};g.name=b.response.docs[0].query;g.docs=b.response.docs;g.depth=0;g.tooltip="query";b.clusters.forEach(function(a){var d={name:"",children:[],docs:[],depth:"",tooltip:""};d.name=a.labels[0];d.docs=a.docs;d.depth=1;d.tooltip="cluster";a.docs.forEach(function(a){var c={rank:"",title:"",description:"",displayUrl:"",url:"",query:"",depth:"",tooltip:""};c.rank=b.response.docs[a-1].rank;c.title=b.response.docs[a-
1].title;c.description=b.response.docs[a-1].description;c.displayUrl=b.response.docs[a-1].displayUrl;c.url=b.response.docs[a-1].url;c.query=b.response.docs[a-1].query;c.depth=2;c.tooltip="serp";d.children.push(c)});g.children.push(d)});return g};
...
{name:b.name,docs:b.docs};ns.sev.clusterPages(c,!1)}}else b.children=b._children,b._children=null,1==b.depth&&(c={name:b.name,docs:b.docs},ns.sev.clusterPages(c,!0));a(b)}var f=parseInt(d3.select("div.cluster").style("width"),10),c=.5*f,e=f-120-120,k=c-20-20,l=0,h=b;h.x0=k/2;h.y0=0;var p=d3.layout.tree().size([k,e]),n=d3.svg.diagonal().projection(function(a){return[a.y,a.x]}),m=d3.select("div#draw-tree").append("svg").style("width",f+"px").style("height",c+"px").append("g").attr("transform","translate(120,20)");
...
ns.sev.getLinksNodesForceJSON=function(b){var g=[],a={},d={name:"",docs:"",links:[],nodes:{}},f={};d.name=b.response.docs[0].query;d.docs=b.response.docs;b.clusters.forEach(function(a){var b=a.labels[0];f[b]={name:b,docs:a.docs};a.docs.forEach(function(b){var c={source:"",target:""};c.source=a.labels[0];c.target=b;g.push(c)})});d.links=g;var c="",e="";g.forEach(function(d){c=d.source;void 0===a[c]?(a[c]={name:c},d.source=a[c],isNaN(c)?(a[c].docs=f[c].docs,a[c].node="innerNode",a[c].tooltip="cluster"):
(a[c].rank=b.response.docs[c-1].rank,a[c].title=b.response.docs[c-1].title,a[c].description=b.response.docs[c-1].description,a[c].displayUrl=b.response.docs[c-1].displayUrl,a[c].url=b.response.docs[c-1].url,a[c].query=b.response.docs[c-1].query,a[c].node="leaf",a[c].tooltip="serp")):d.source=a[c];e=d.target;void 0===a[e]?(a[e]={name:e},d.target=a[e],isNaN(e)?(a[e].docs=f[e].docs,a[e].node="innerNode",a[e].tooltip="cluster"):(a[e].rank=b.response.docs[e-1].rank,a[e].title=b.response.docs[e-1].title,
a[e].description=b.response.docs[e-1].description,a[e].displayUrl=b.response.docs[e-1].displayUrl,a[e].url=b.response.docs[e-1].url,a[e].query=b.response.docs[e-1].query,a[e].node="leaf",a[e].tooltip="serp")):d.target=a[e]});d.nodes=a;return d};
...
ns.sev.getClusterNodesJSON=function(b){var g={name:"",nodes:[],clusters:[]},a=-1;g.name=b.response.docs[0].query;b.clusters.forEach(function(d){a++;var f={name:"",docs:[]};f.name=d.labels[0];f.docs=d.docs;g.clusters.push(f);d.docs.forEach(function(c){var e={clusterNode:!0,rank:"",title:"",description:"",displayUrl:"",url:"",query:"",depth:"",clusterName:"",clusterDocs:[],cluster:"",radius:"",color:"",tooltip:"cluster_serp"};e.rank=b.response.docs[c-1].rank;e.title=b.response.docs[c-1].title;e.description=
b.response.docs[c-1].description;e.displayUrl=b.response.docs[c-1].displayUrl;e.url=b.response.docs[c-1].url;e.query=b.response.docs[c-1].query;e.depth=2;e.clusterName=d.labels[0];e.clusterDocs=d.docs;e.cluster=a;c=e.rank;var f=b.response.docs.length;e.radius=20*Math.sqrt(.5*(c/f+1)*-Math.log(c/(f+20)));g.nodes.push(e)})});return g};
...
ns.sev.clusterPages=function(b,g){var a=ns.sev.resultSolrJSON;g?ns.sev.clusters.push(b):ns.sev.clusters.every(function(a,d,f){return a.name==b.name?(ns.sev.clusters.splice(d,1),!1):!0});if(0==ns.sev.clusters.length)ns.sev.refreshSerps(a);else{var d=[];ns.sev.clusters.forEach(function(a){d=_.union(d,a.docs)});d.sort(function(a,b){return a-b});var f="";d.forEach(function(b){f+="<tr>";f+="<td>";f+="<h5>";f+="<span>"+a.response.docs[b-1].rank+" | </span>";f+="<a href='"+a.response.docs[b-1].url+"' target='_blank'> "+
a.response.docs[b-1].title+" </a>";f+="</h5>";f+="<p class='text-success'>"+a.response.docs[b-1].displayUrl+"</p>";f+="<p>"+a.response.docs[b-1].description+"</p>";f+="</td>";f+="</tr>"});$("tbody#hilitor tr").remove();$("table.table").find("tbody#hilitor").append(f);ns.sev.setQueryStringBold(document.getElementById("input-query").value,"hilitor")}};
ns.sev.refreshSerps=function(b){ns.sev.currentPage=1;ns.sev.serpsPerPage=10;ns.sev.clusters=[];var g;b.response.docs.length>=ns.sev.serpsPerPage?g=ns.sev.serpsPerPage:g=b.response.docs.length;for(var a="",d=0;d<g;d++)a+="<tr>",a+="<td>",a+="<h5>",a+="<span>"+b.response.docs[d].rank+" | </span>",a+="<a href='"+b.response.docs[d].url+"' target='_blank'> "+b.response.docs[d].title+" </a>",a+="</h5>",a+="<p class='text-success'>"+b.response.docs[d].displayUrl+"</p>",a+="<p>"+b.response.docs[d].description+
