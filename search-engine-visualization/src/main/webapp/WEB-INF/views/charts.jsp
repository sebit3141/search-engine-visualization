...
<div class="row">
	<div class="col-lg-12">
		...
		<p class="lead">
			...
			on simple usage, attractive looks and interactive features. For full
			usage instructions and documentation for Flot Charts, visit <a
...
<div class="row">
	<div class="col-lg-12">
		...
		<p class="lead">
			Morris.js is a very simple API for drawing line, bar, area and donut
			charts. For full usage instructions and documentation for Morris.js
			charts, visit <a href="http://www.oesmith.co.uk/morris.js/">http://www.oesmith.co.uk/morris.js/</a>.
		</p>
	</div>
</div>
<!-- /.row -->
